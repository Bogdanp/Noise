/* scheme.h for Chez Scheme Version 10.4.0-pre-release.1 (tpb64l) */
...
#define SPINLOCK(addr) S_pb_spinlock(addr)
#define LOCKED_INCR(addr, res) (res = S_pb_locked_adjust(addr, 1))
#define LOCKED_DECR(addr, res) (res = S_pb_locked_adjust(addr, -1))
